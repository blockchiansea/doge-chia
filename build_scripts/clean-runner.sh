...
rm -rf ../venv || true
rm -rf venv || true
rm -rf dogechia_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf dogechia-blockchain-gui/build || true
rm -rf dogechia-blockchain-gui/daemon || true
rm -rf dogechia-blockchain-gui/node_modules || true
rm dogechia-blockchain-gui/temp.json || true
( cd "$PWD/dogechia-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
