...
"""
run_block: Convert an encoded FullBlock from the Dogechia blockchain into a list of transactions

As input, takes a file containing a [FullBlock](../dogechia/types/full_block.py) in json format
...
$ca_root is the directory containing your current Dogechia config files
$hash is the header_hash of the [BlockRecord](../dogechia/consensus/block_record.py)
...
The information for each spend is an "NPC" (Name, Puzzle, Condition):
        ...
        "conditions": a list of condition expressions, as in [condition_opcodes.py](../dogechia/types/condition_opcodes.py)
...
from dogechia.wallet.cat_wallet.cat_utils import match_cat_puzzle
from dogechia.wallet.puzzles.load_clvm import load_serialized_clvm_maybe_recompile
from dogechia.wallet.uncurried_puzzle import uncurry_puzzle

DESERIALIZE_MOD = load_serialized_clvm_maybe_recompile(
    "chialisp_deserialisation.clsp", package_or_requirement="dogechia.wallet.puzzles"
)
