"""
Provides a helper to access the legacy keyring which was supported up to version 1.6.1 of doge-chia. To use this
...
from dogechia.util.errors import KeychainUserNotFound
from dogechia.util.keychain import KeyData, KeyDataSecrets, get_private_key_user
...
DEFAULT_USER = f"user-dogechia-{CURRENT_KEY_VERSION}"  # e.g. user-dogechia-1.8
DEFAULT_SERVICE = f"dogechia-{DEFAULT_USER}"  # e.g. dogechia-user-dogechia-1.8
MAX_KEYS = 100
