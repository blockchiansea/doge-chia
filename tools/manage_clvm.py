...
root = here.parent
cache_path = root.joinpath(".dogechia_cache", "manage_clvm.json")
...
from dogechia.types.blockchain_format.serialized_program import SerializedProgram  # noqa: E402
...
top_levels = {"dogechia"}
hashes_path = root.joinpath("dogechia/wallet/puzzles/deployed_puzzle_hashes.json")
std_libraries = root.joinpath("dogechia/wallet/puzzles")
...
main(auto_envvar_prefix="DOGECHIA_MANAGE_CLVM")
