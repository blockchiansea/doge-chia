...
from dogechia.simulator.block_tools import make_unfinished_block
...
async def run_sync_test(
    ...
    with tempfile.TemporaryDirectory() as root_dir:
        ...
        dogechia_init(root_path, should_check_keys=False, v1_db=(db_version == 1))
        ...
        try:
            full_node.set_server(cast(DogechiaServer, FakeServer()))
            ...
            peer: WSDogechiaConnection = cast(WSDogechiaConnection, FakePeer())
...
async def run_sync_checkpoint(
    ...
    dogechia_init(root_path, should_check_keys=False, v1_db=False)
    config = load_config(root_path, "config.yaml")
    ...
    try:
        ...
        peer: WSDogechiaConnection = FakePeer()  # type: ignore[assignment]
