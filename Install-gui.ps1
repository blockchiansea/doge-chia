...
{
    Write-Output "This script requires that the Dogechia Python virtual environment is activated."
...
Push-Location
try {
    Set-Location dogechia-blockchain-gui
    ...
    Write-Output ""
    Write-Output "Dogechia blockchain Install-gui.ps1 completed."
    Write-Output ""
    Write-Output "Type 'cd dogechia-blockchain-gui' and then 'npm run electron' to start the GUI."
} finally {
    Pop-Location
}
