...
{
    Write-Output "Dogechia requires a 64-bit Windows installation"
    Exit 1
}
...
Write-Output ""
Write-Output "Dogechia blockchain .\Install.ps1 complete."
Write-Output "For assistance join us on Discord in the #support chat channel:"
Write-Output "https://discord.gg/dogechia"
Write-Output ""
Write-Output "Try the Quick Start Guide to running doge-chia:"
Write-Output "https://github.com/blockchiansea/doge-chia/wiki/Quick-Start-Guide"
Write-Output ""
Write-Output "To install the GUI run '.\venv\scripts\Activate.ps1' then '.\Install-gui.ps1'."
Write-Output ""
Write-Output "Type '.\venv\Scripts\Activate.ps1' and then 'dogechia init' to begin."
