...
# https://github.com/blockchiansea/doge-chia/pull/10460#issuecomment-1054492495
...
if [ ! "$CI" ]; then
  ...
  # Set modified output of `dogechia version` to version property of GUI's package.json
