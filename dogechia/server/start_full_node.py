...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("DOGECHIA_INSTRUMENT_NODE") is not None):
        ...
        if not service_config.get("use_dogechia_loop_policy", True):
            target_peer_count = None
