...
from dogechia.protocols.protocol_state_machine import message_response_ok
from dogechia.protocols.protocol_timing import API_EXCEPTION_BAN_SECONDS, INTERNAL_PROTOCOL_ERROR_BAN_SECONDS
from dogechia.protocols.shared_protocol import Capability, Handshake
from dogechia.server.capabilities import known_active_capabilities
...
from dogechia.util.api_decorators import get_metadata
from dogechia.util.errors import Err, ProtocolError
from dogechia.util.ints import uint8, uint16
from dogechia.util.log_exceptions import log_exceptions

# Each message is prepended with LENGTH_BYTES bytes specifying the length
from dogechia.util.network import class_for_type, is_localhost
from dogechia.util.streamable import Streamable

# Max size 2^(8*4) which is around 4GiB
LENGTH_BYTES: int = 4

WebSocket = Union[WebSocketResponse, ClientWebSocketResponse]
ConnectionCallback = Callable[["WSDogechiaConnection"], Awaitable[None]]
