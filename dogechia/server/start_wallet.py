...
from dogechia.util.task_timing import maybe_manage_task_instrumentation
from dogechia.wallet.wallet_node import WalletNode

# See: https://bugs.python.org/issue29288
from dogechia.wallet.wallet_node_api import WalletNodeAPI
...
async def async_main() -> int:
    ...
    if local_test is True:
        from dogechia.simulator.block_tools import test_constants
...
def main() -> int:
    ...
    with maybe_manage_task_instrumentation(enable=os.environ.get("DOGECHIA_INSTRUMENT_WALLET") is not None):
