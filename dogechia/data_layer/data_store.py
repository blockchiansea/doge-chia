...
from dogechia.data_layer.data_layer_errors import KeyNotFoundError, NodeHashError, TreeGenerationIncrementingError
...
class DataStore:
    ...
    async def _insert_root(
        ...
        # https://github.com/blockchiansea/doge-chia/pull/9284
