...
from dogechia.consensus.coinbase import create_farmer_coin, create_pool_coin, create_puzzlehash_for_pk
...
from dogechia.consensus.deficit import calculate_deficit
from dogechia.consensus.full_block_to_block_record import block_to_block_record
...
from dogechia.consensus.vdf_info_computation import get_signage_point_vdf_info
from dogechia.daemon.keychain_proxy import KeychainProxy, connect_to_keychain_and_validate, wrap_local_keychain
from dogechia.full_node.bundle_tools import (
    best_solution_generator_from_template,
    detect_potential_template_generator,
    simple_solution_generator,
)
from dogechia.full_node.signage_point import SignagePoint
from dogechia.plotting.create_plots import PlotKeys, create_plots
from dogechia.plotting.manager import PlotManager
from dogechia.plotting.util import (
    Params,
    PlotRefreshEvents,
    PlotRefreshResult,
...
from dogechia.simulator.socket import find_available_listen_port
from dogechia.simulator.ssl_certs import (
...
from dogechia.simulator.time_out_assert import time_out_assert_custom_interval
from dogechia.simulator.wallet_tools import WalletTool
from dogechia.ssl.create_ssl import create_all_ssl
...
from dogechia.types.blockchain_format.foliage import Foliage, FoliageBlockData, FoliageTransactionBlock, TransactionsInfo
from dogechia.types.blockchain_format.pool_target import PoolTarget
from dogechia.types.blockchain_format.program import INFINITE_COST, Program
from dogechia.types.blockchain_format.proof_of_space import (
    ProofOfSpace,
...
from dogechia.types.blockchain_format.reward_chain_block import RewardChainBlockUnfinished
from dogechia.types.blockchain_format.sized_bytes import bytes32
from dogechia.types.blockchain_format.slots import (
...
from dogechia.types.blockchain_format.vdf import VDFInfo, VDFProof
...
from dogechia.types.generator_types import BlockGenerator, CompressorArg
...
from dogechia.util.prev_transaction_block import get_prev_transaction_block
from dogechia.util.vdf_prover import get_vdf_info_and_proof
...
from dogechia.wallet.puzzles.rom_bootstrap_generator import GENERATOR_MOD
...
class BlockTools:
    ...
    def __init__(
        ...
        if automated_testing:
            ...
            create_default_dogechia_config(root_path)
            create_all_ssl(
                root_path,
        ...
        try:
            if self.local_keychain:
                ...
                keychain_proxy = await connect_to_keychain_and_validate(
                    self.root_path, self.log, user="testing-1.8.0", service="dogechia-testing-1.8.0"
                )
            ...
            if len(self.pool_pubkeys) == 0 or len(self.farmer_pubkeys) == 0:
                raise RuntimeError("Keys not generated. Run `dogechia keys generate`")
        ...
        try:
            if plot_keys is None:
                ...
                if pool_contract_puzzle_hash is None:
                    ...
                    pool_address = encode_puzzle_hash(pool_contract_puzzle_hash, "xdg")
