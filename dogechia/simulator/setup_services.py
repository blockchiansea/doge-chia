...
from dogechia.cmds.init_funcs import init
...
from dogechia.introducer.introducer import Introducer
from dogechia.protocols.shared_protocol import Capability, capabilities
from dogechia.server.start_farmer import create_farmer_service
from dogechia.server.start_full_node import create_full_node_service
from dogechia.server.start_harvester import create_harvester_service
from dogechia.server.start_introducer import create_introducer_service
from dogechia.server.start_service import Service
from dogechia.server.start_timelord import create_timelord_service
from dogechia.server.start_wallet import create_wallet_service
from dogechia.simulator.block_tools import BlockTools
from dogechia.simulator.keyring import TempKeyring
from dogechia.simulator.start_simulator import create_full_node_simulator_service
...
from dogechia.util.config import config_path_for_filename, lock_and_load_config, save_config
from dogechia.util.ints import uint16
from dogechia.util.keychain import bytes_to_mnemonic
...
async def setup_wallet_node(
    ...
    with TempKeyring(populate=True) as keychain:
        ...
        service_config["xdg_spam_amount"] = xdg_spam_amount
...
async def setup_farmer(
    ...
    service_config["xdg_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "xdg")
