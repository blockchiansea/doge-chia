...
from dogechia.rpc.rpc_server import default_get_connections
from dogechia.server.outbound_message import NodeType
from dogechia.simulator.block_tools import BlockTools
from dogechia.simulator.simulator_protocol import FarmNewBlockProtocol, GetAllCoinsProtocol, ReorgProtocol
from dogechia.simulator.time_out_assert import adjusted_timeout
...
class FullNodeSimulator(FullNodeAPI):
    ...
    async def farm_blocks_to_puzzlehash(
        ...
        is to receive XDG at an address.
