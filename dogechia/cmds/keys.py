...
@click.option(
    ...
    "-d",
    help=(
        "Show the first wallet address using non-observer derivation. Older Dogechia versions use "
...
@click.option("--prefix", "-x", help="Address prefix (xdg for mainnet, txdg for testnet)", default=None, type=str)
@click.pass_context
def search_cmd(
    ctx: click.Context,
