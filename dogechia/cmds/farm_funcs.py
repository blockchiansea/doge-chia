...
from dogechia.util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total dogechia farmed: {amounts['farmed_amount'] / units['dogechia']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['dogechia']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['pool_reward_amount']) / units['dogechia']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'dogechia start wallet' and 'dogechia wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'dogechia wallet show'")
    else:
        print("Note: log into your key using 'dogechia wallet show' to see rewards for each key")
