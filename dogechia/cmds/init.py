...
@click.option("--testnet", is_flag=True, help="Configure this dogechia install to connect to the testnet")
...
def init_cmd(
    ...
    - Get more details on remote harvester on Dogechia wiki:
      https://github.com/blockchiansea/doge-chia/wiki/Farming-on-many-machines
    """
    from pathlib import Path

    from dogechia.cmds.passphrase_funcs import initialize_passphrase
