...
from dogechia.util.config import load_defaults_for_missing_services, lock_and_load_config, save_config, str2bool
    ...
    with lock_and_load_config(root_path, config_yaml, fill_missing_services=True) as config:
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "58444"
                testnet_introducer = "introducer-testnet10.dogechi.org"
                testnet_dns_introducer = "dns-introducer-testnet10.dogechi.org"
                bootstrap_peers = ["testnet10-node.dogechi.org"]
                testnet = "testnet10"
                ...
                mainnet_port = "8444"
                mainnet_introducer = "introducer.dogechi.org"
                mainnet_dns_introducer = "dns-introducer.dogechi.org"
                bootstrap_peers = ["node.dogechi.org"]
                net = "mainnet"
        ...
        if change_made:
            print("Restart any running dogechia services for changes to take effect")
