...
from dogechia.util.collection import find_duplicates
from dogechia.util.db_synchronous import db_synchronous_on
from dogechia.util.db_wrapper import DBWrapper2, execute_fetchone
from dogechia.util.pprint import print_compact_ranges
...
help_text = """
\b
    The purpose of this command is find potential issues in Dogechia wallet databases.
    The core dogechia client currently uses sqlite to store the wallet databases, one database per key.
\b
