...
from dogechia.cmds.cmds_util import NODE_TYPES
from dogechia.cmds.peer_funcs import peer_async
...
@click.option("-a", "--add-connection", help="Connect specified Dogechia service to ip:port", type=str, default="")
@click.option(
