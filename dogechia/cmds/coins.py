...
@click.option(
    ...
    "amounts_to_exclude",
    multiple=True,
    help="Exclude any coins with this XDG or CAT amount from being included.",
)
@click.option(
...
@click.option(
    "-a",
    "--target-amount",
    help="Select coins until this amount (in XDG or CAT) is reached. \
...
@click.option(
    "-a",
    "--amount-per-coin",
    help="The amount of each newly created coin, in XDG",
    type=str,
    required=True,
)
