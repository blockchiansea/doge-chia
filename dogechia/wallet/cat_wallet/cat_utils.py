...
from dogechia.util.condition_tools import conditions_dict_for_solution
...
def empty_program() -> Program:
    ...
    # https://github.com/Chia-Network/clvmm/pull/102
    # https://github.com/Chia-Network/clvmm/pull/106
