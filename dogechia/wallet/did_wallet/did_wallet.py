...
from dogechia.wallet.coin_selection import select_coins
from dogechia.wallet.derivation_record import DerivationRecord
from dogechia.wallet.derive_keys import master_sk_to_wallet_sk_unhardened
from dogechia.wallet.did_wallet import did_wallet_puzzles
from dogechia.wallet.did_wallet.did_info import DIDInfo
from dogechia.wallet.did_wallet.did_wallet_puzzles import uncurry_innerpuz
...
from dogechia.wallet.singleton import (
...
class DIDWallet:
    ...
    async def coin_added(self, coin: Coin, _: uint32, peer: WSDogechiaConnection):
    ...
    async def create_update_spend(self, fee: uint64 = uint64(0), reuse_puzhash: Optional[bool] = None):
        ...
        if dogechia_tx is not None and dogechia_tx.spend_bundle is not None:
            ...
            await self.wallet_state_manager.add_pending_transaction(dogechia_tx)
