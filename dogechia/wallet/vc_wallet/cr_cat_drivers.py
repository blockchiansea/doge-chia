...
from dogechia.wallet.cat_wallet.cat_utils import construct_cat_puzzle
from dogechia.wallet.lineage_proof import LineageProof
from dogechia.wallet.payment import Payment
from dogechia.wallet.puzzles.cat_loader import CAT_MOD
from dogechia.wallet.puzzles.load_clvm import load_clvm_maybe_recompile
from dogechia.wallet.puzzles.singleton_top_layer_v1_1 import SINGLETON_LAUNCHER_HASH, SINGLETON_MOD_HASH
from dogechia.wallet.uncurried_puzzle import UncurriedPuzzle, uncurry_puzzle
from dogechia.wallet.vc_wallet.vc_drivers import (
    COVENANT_LAYER_HASH,
...
CREDENTIAL_RESTRICTION: Program = load_clvm_maybe_recompile(
    ...
    package_or_requirement="dogechia.wallet.vc_wallet.cr_puzzles",
