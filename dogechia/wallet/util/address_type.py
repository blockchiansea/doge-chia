...
from dogechia.util.config import selected_network_address_prefix
...
class AddressType(Enum):
    ...
    def hrp(self, config: Dict[str, Any]) -> str:
        if self == AddressType.XDG:
            # Special case to map XDG to the current network's address prefix
