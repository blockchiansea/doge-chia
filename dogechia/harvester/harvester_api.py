...
from dogechia.plotting.util import PlotInfo, parse_plot_info
from dogechia.protocols import harvester_protocol
from dogechia.protocols.farmer_protocol import FarmingInfo
from dogechia.protocols.harvester_protocol import Plot, PlotSyncResponse
...
from dogechia.wallet.derive_keys import master_sk_to_local_sk
...
class HarvesterAPI:
    ...
    async def harvester_handshake(
        self, harvester_handshake: harvester_protocol.HarvesterHandshake, peer: WSDogechiaConnection
    ) -> None:
        """
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSDogechiaConnection
    ) -> None:
        """
