...
from dogechia.util.default_root import DEFAULT_KEYS_ROOT_PATH
from dogechia.util.file_keyring import FileKeyring
...
# the new passphrase.
DEFAULT_PASSPHRASE_IF_NO_MASTER_PASSPHRASE = "$ dogechia passphrase set # all the cool kids are doing it!"

MASTER_PASSPHRASE_SERVICE_NAME = "Dogechia Passphrase"
MASTER_PASSPHRASE_USER_NAME = "Dogechia Passphrase"
...
class KeyringWrapper:
    ...
    def _get_initial_cached_passphrase(self) -> str:
        ...
        """
        from dogechia.util.keychain import supports_os_passphrase_storage
