...
from dogechia.consensus.pot_iterations import calculate_sp_iters, is_overflow_block
...
from dogechia.timelord.iters_from_block import iters_from_block
from dogechia.timelord.timelord_state import LastState
from dogechia.timelord.types import Chain, IterationType, StateType
from dogechia.types.blockchain_format.classgroup import ClassgroupElement
from dogechia.types.blockchain_format.reward_chain_block import RewardChainBlock
...
from dogechia.util.config import process_config_start_method
...
class Timelord:
    ...
    def __init__(self, root_path: Path, config: Dict[str, Any], constants: ConsensusConstants) -> None:
        ...
        self._server: Optional[DogechiaServer] = None
