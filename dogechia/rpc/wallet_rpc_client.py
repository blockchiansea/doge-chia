...
from dogechia.data_layer.data_layer_wallet import Mirror, SingletonRecord
from dogechia.pools.pool_wallet_info import PoolWalletInfo
...
from dogechia.wallet.util.query_filter import TransactionTypeFilter
from dogechia.wallet.util.wallet_types import WalletType
from dogechia.wallet.vc_wallet.vc_store import VCRecord
...
class WalletRpcClient(RpcClient):
    """
    Client to Dogechia RPC, connects to a local wallet. Uses HTTP/JSON, and converts back from
    ...
    async def nft_mint_bulk(
        ...
        xdg_coins: Optional[List[Dict]] = None,
        xdg_change_target: Optional[str] = None,
        ...
        request = {
            ...
            "xdg_coins": xdg_coins,
            "xdg_change_target": xdg_change_target,
