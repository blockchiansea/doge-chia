...
from dogechia.data_layer.data_layer_errors import OfferIntegrityError
...
from dogechia.data_layer.data_layer_wallet import DataLayerWallet, Mirror, verify_offer
from dogechia.rpc.data_layer_rpc_util import marshal
...
from dogechia.util.ws_message import WsRpcMessage
from dogechia.wallet.trading.offer import Offer as TradingOffer

if TYPE_CHECKING:
    from dogechia.data_layer.data_layer import DataLayer
...
class DataLayerRpcApi:
    ...
    def __init__(self, data_layer: DataLayer):  # , wallet: DataLayerWallet):
        ...
        self.service_name = "dogechia_data_layer"
