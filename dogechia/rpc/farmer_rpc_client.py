...
from dogechia.rpc.farmer_rpc_api import PlotInfoRequestData, PlotPathRequestData
from dogechia.rpc.rpc_client import RpcClient
from dogechia.types.blockchain_format.sized_bytes import bytes32
from dogechia.util.misc import dataclass_to_json_dict


class FarmerRpcClient(RpcClient):
    """
    Client to Dogechia RPC, connects to a local farmer. Uses HTTP/JSON, and converts back from
