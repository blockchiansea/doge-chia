...
from dogechia.full_node.mempool import Mempool
from dogechia.full_node.mempool_check_conditions import mempool_check_conditions_dict, get_name_puzzle_conditions
from dogechia.full_node.pending_tx_cache import PendingTxCache
...
from dogechia.types.mempool_item import MempoolItem
from dogechia.types.spend_bundle import SpendBundle
from dogechia.util.clvm import int_from_bytes
...
from dogechia.util.streamable import recurse_jsonify
...
class MempoolManager:
    def __init__(self, coin_store: CoinStore, consensus_constants: ConsensusConstants):
        ...
        # spends.
        self.nonzero_fee_minimum_fpc = 5v
