...
from dogechia.consensus.block_record import BlockRecordProtocol
from dogechia.consensus.constants import ConsensusConstants
from dogechia.consensus.cost_calculator import NPCResult
from dogechia.full_node.bitcoin_fee_estimator import create_bitcoin_fee_estimator
from dogechia.full_node.bundle_tools import simple_solution_generator
from dogechia.full_node.fee_estimation import FeeBlockInfo, MempoolInfo, MempoolItemInfo
from dogechia.full_node.fee_estimator_interface import FeeEstimatorInterface
from dogechia.full_node.mempool import MEMPOOL_ITEM_FEE_LIMIT, Mempool, MempoolRemoveReason
from dogechia.full_node.mempool_check_conditions import get_name_puzzle_conditions, mempool_check_time_locks
from dogechia.full_node.pending_tx_cache import ConflictTxCache, PendingTxCache
from dogechia.types.blockchain_format.coin import Coin
from dogechia.types.blockchain_format.sized_bytes import bytes32, bytes48
from dogechia.types.clvm_cost import CLVMCost
from dogechia.types.coin_record import CoinRecord
from dogechia.types.fee_rate import FeeRate
from dogechia.types.mempool_inclusion_status import MempoolInclusionStatus
from dogechia.types.mempool_item import BundleCoinSpend, MempoolItem
...
class MempoolManager:
    ...
    def __init__(
        ...
        *,
        ...
        # transactions. This prevents spam. This is equivalent to 0.055 XDG per block, or about 0.00005 XDG for two
        # spends.
