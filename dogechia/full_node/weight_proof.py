...
from dogechia.consensus.block_header_validation import validate_finished_header_block
...
from dogechia.consensus.full_block_to_block_record import header_block_to_sub_block_record
...
from dogechia.types.blockchain_format.slots import ChallengeChainSubSlot, RewardChainSubSlot
...
from dogechia.types.weight_proof import (
    RecentChainData,
...
def _create_shutdown_file() -> IO[bytes]:
    return tempfile.NamedTemporaryFile(prefix="dogechia_full_node_weight_proof_handler_executor_shutdown_trigger")
