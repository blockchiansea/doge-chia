...
from dogechia.seeder.crawl_store import CrawlStore
from dogechia.seeder.peer_record import PeerRecord, PeerReliability
...
class Crawler:
    ...
    async def connect_task(self, peer):
        async def peer_action(peer: WSDogechiaConnection):
    ...
    async def new_peak(self, request: full_node_protocol.NewPeak, peer: WSDogechiaConnection):
        try:
            peer_info = peer.get_peer_info()
    ...
    async def on_connect(self, connection: WSDogechiaConnection):
        pass
