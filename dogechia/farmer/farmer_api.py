...
import dogechia.server.ws_connection as ws
...
from dogechia.protocols.harvester_protocol import PoolDifficulty
...
from dogechia.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSDogeChiaConnection
    ):
        """
