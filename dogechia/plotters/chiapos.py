"""
NOTE: This contains duplicate code from `dogechia.cmds.plots`.
After `dogechia plots create` becomes obsolete, consider removing it from there.
"""
...
from dogechia.plotting.util import Params, add_plot_directory, validate_plot_size
...
def get_chiapos_install_info() -> Optional[Dict[str, Any]]:
    ...
    return {"display_name": "Dogechia Proof of Space", "version": chiapos_version, "installed": True}


def plot_dogechia(args: Namespace, root_path: Path) -> None:
    try:
