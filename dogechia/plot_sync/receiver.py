...
from dogechia.plot_sync.delta import Delta, PathListDelta, PlotListDelta
from dogechia.plot_sync.exceptions import (
...
from dogechia.plot_sync.util import ErrorCodes, State, T_PlotSyncMessage
...
from dogechia.server.outbound_message import make_msg
...
from dogechia.util.misc import get_list_or_len
...
class Receiver:
    _connection: WSDogechiaConnection
    _current_sync: Sync
    _last_sync: Sync
    ...
    def connection(self) -> WSDogechiaConnection:
