...
from dogechia.plot_sync.exceptions import AlreadyStartedError, InvalidConnectionTypeError
from dogechia.plot_sync.util import Constants
from dogechia.plotting.manager import PlotManager
from dogechia.plotting.util import PlotInfo
...
from dogechia.util.generator_tools import list_to_batches
from dogechia.util.ints import int16, uint32, uint64
...
class Sender:
    ...
    _connection: Optional[WSDogechiaConnection]
    _sync_id: uint64
    ...
    def set_connection(self, connection: WSDogechiaConnection) -> None:
